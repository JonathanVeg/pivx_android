package altcoin.br.pivx.widget;
...
import altcoin.br.pivx.MainActivity;
...
public class CoinWidgetProvider extends AppWidgetProvider {
    ...
    private static String WIDGET_BUTTON = "android.appwidget.action.UPDATE_PIVX_WIDGET";
    ...
    private void loadDataFromBittrex(final Context context, AppWidgetManager appWidgetManager, final int appWidgetId, final String fiat) {
        ...
        views.setTextViewText(R.id.tvWidNameCoin, "PIVX - Trex - " + getHour());
    ...
    private void loadDataFromBleutrade(final Context context, AppWidgetManager appWidgetManager, final int appWidgetId, final String fiat) {
        ...
        views.setTextViewText(R.id.tvWidNameCoin, "PIVX - Bleu - " + getHour());

        String url = "https://bleutrade.com/api/v2/public/getmarketsummary?market=PIVX_BTC";
    ...
    private class atParsePoloniexData extends AsyncTask<Void, Void, Void> {
        ...
        atParsePoloniexData(final Context context, AppWidgetManager appWidgetManager, final int appWidgetId, final String fiat, String data) {
            ...
            views.setTextViewText(R.id.tvWidNameCoin, "PIVX - Polo - " + getHour());
        }
